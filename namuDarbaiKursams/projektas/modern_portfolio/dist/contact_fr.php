...
<!DOCTYPE html>
<html <?php include('includes/fr/lang_fr.php'); ?> >
...
<head>
  ...
  <?php include('includes/fr/titre_fr.php'); ?>
</head>

<body>
	<?php include('includes/fr/header.php'); ?>

  <?php include('includes/fr/main-contact.php'); ?>
  
	<?php include('includes/fr/contact-form.php'); ?>
