<main id="work">
	<h1 class="lg-heading">
		Mes
		<span class="text-secondary">Projets</span>
	</h1>
	<h2 class="sm-heading">
		Voici un aperçu de mes projects...
	</h2>
	<div class="projects">
		<div class="item">
			<a href="#!">
			...
			<a href="https://github.com/hyneryl/kursas1/commit/21e8e9e8059a1e4c71604ad650b5592f0d73e229" class="btn-dark" alt="Projet Fiche renseignement" title="Project of my form page">
		...
		<div class="item">
			...
			<a href="https://github.com/hyneryl/kursas1/tree/master/namuDarbaiKursams/css/css4" title="Projet site Web Musical" alt="Projet site Web Musical" class="btn-dark">
				<i class="fab fa-github"></i> Github
			</a>
		</div>
		<div class="item">
